(function (factory) {
	...
	$.Poshytip = function(elm, options) {
		...
		this.$tip = $(['<div class="',this.opts.className,'">',
			...
			'</div>'].join('')).appendTo(this.$elm.offsetParent());
	...
	$.Poshytip.prototype = {
		...
		refresh: function(async) {
			...
			this.$tip.css({left: 0, top: 0}).appendTo(this.$elm.offsetParent());
	...
	$.fn.poshytip = function(options) {
		...
		if (!$('#poshytip-css-' + opts.className)[0])
			$(['<style id="poshytip-css-',opts.className,'" type="text/css">',
				'div.',opts.className,'{visibility:hidden;position:absolute;z-index:29;top:0;left:0;}',
				...
				'div.',opts.className,' div.tip-arrow{visibility:hidden;position:absolute;z-index:29;overflow:hidden;font:1px/1px sans-serif;}',
